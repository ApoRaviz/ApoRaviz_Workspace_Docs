...
> ชื่อไฟล์ไม่มีเลขนำหน้า (เป็น topic slug ล้วน) — **ลำดับการอ่านคือ 1-14 ตาม stage ด้านล่าง** ที่จัดไว้ในหน้านี้ + sidebar เท่านั้น ลำดับอยู่ที่ presentation ไม่ผูกกับชื่อไฟล์ เวลาจัดใหม่จึงแก้แค่ที่นี่ (ดู No Number Prefix Rule ใน `../../TEACHING_RULES.md`)
...
9. [Data Binding, UI State และ Component Test](data-binding-ui-state-and-component-testing.md)

**Stage 3 — Rendering / SSR**

10. [App Config, SSR และ Hydration](app-config-ssr-hydration.md)
11. [Browser APIs และ SSR Safety](browser-apis-ssr-safety.md)

**Stage 4 — Styling**

12. [Tailwind CSS v4 ใน Angular](tailwind-css-v4.md)

**Stage 5 — Quality & Ops**

13. [Unit Test และ Regression Safety](unit-test-regression.md)
14. [CI/CD และ GitHub Pages](cicd-github-pages.md)
...
- อ่าน `data-binding-ui-state-and-component-testing.md` แล้วตามว่า event, Signal, HTTP response, change detection และ DOM ต่อกันอย่างไร
