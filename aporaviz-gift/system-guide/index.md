...
> เอกสารชุดนี้คัดลอกมาจาก `ApoRaviz_Gift/docs/system-guide/` เพื่อเปิดอ่านบน VitePress ชั่วคราว เมื่ออ่านเสร็จแล้วสามารถลบหมวด `aporaviz-gift/` และรายการเมนูที่เกี่ยวข้องออกได้

## ลำดับแนะนำ

1. [System Overview](./SYSTEM_OVERVIEW.md) — ภาพรวมและขอบเขตของระบบ
...
10. [Authentication and Security](./AUTHENTICATION_AND_SECURITY.md) — token, permission และ security
