    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'System Overview', link: '/aporaviz-gift/system-guide/SYSTEM_OVERVIEW' },
          ...
          { text: 'Authentication and Security', link: '/aporaviz-gift/system-guide/AUTHENTICATION_AND_SECURITY' },
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: '8 HttpClient and HTTP Unit Test', link: '/angular/teach/http-client-and-http-testing' },
              { text: '9 App Config, SSR and Hydration', link: '/angular/teach/app-config-ssr-hydration' },
              { text: '10 Browser APIs and SSR Safety', link: '/angular/teach/browser-apis-ssr-safety' },
              { text: '11 Tailwind CSS v4', link: '/angular/teach/tailwind-css-v4' },
              { text: '12 Unit Test and Regression Safety', link: '/angular/teach/unit-test-regression' },
              { text: '13 CI/CD and GitHub Pages', link: '/angular/teach/cicd-github-pages' },
            ],
          },
          {
            text: 'Reference',
