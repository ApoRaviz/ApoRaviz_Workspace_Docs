        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                text: '9 Data Binding, UI State and Component Test',
                link: '/angular/teach/data-binding-ui-state-and-component-testing',
              },
              { text: '10 App Config, SSR and Hydration', link: '/angular/teach/app-config-ssr-hydration' },
              { text: '11 Browser APIs and SSR Safety', link: '/angular/teach/browser-apis-ssr-safety' },
              { text: '12 Tailwind CSS v4', link: '/angular/teach/tailwind-css-v4' },
              { text: '13 Unit Test and Regression Safety', link: '/angular/teach/unit-test-regression' },
              { text: '14 CI/CD and GitHub Pages', link: '/angular/teach/cicd-github-pages' },
            ],
          },
          {
            text: 'Reference',
